...
@WebServlet(name = "delete-amenity", value = "/delete-amenity")
public class DeleteAmenityController extends HttpServlet {
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            sendResponse(response, Messages.AMENITY_DELETED,null,null,200);
        }catch(DBException e){
            e.printStackTrace();
