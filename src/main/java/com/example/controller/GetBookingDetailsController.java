...
@WebServlet(name = "get-booking-details", value = "/get-booking-details")
public class GetBookingDetailsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            BookingDTO booking = service.getBookingDetails(id);
            sendResponse(response,null,null,booking,200);
        } catch (DBException e) {
            e.printStackTrace();
